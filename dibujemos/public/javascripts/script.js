$(function(){
  ...
  function moveHandler(data) {
    if(! (data.id in clients)){
      // le damos un cursor a cada usuario nuestro mediante su id generada
  ...
  //Detecta cuando se pulsa clic con el mouse
  ...
  //Detecta cuando se deja el clic sostenido y se arrastra el cursor
  ...
  //Función para trazar una linea en pantalla mediante el moviemiento del cursor
  ...
  //Imprime la cantidad de usuarios conectados en consola
  ...
  //Se adjuntan los eventos al socket
